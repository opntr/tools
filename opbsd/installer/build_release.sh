...
BRANCH_11="opbsd/11-stable/master"
...
INSTALLER_SETS_RELEASE_DIR="./pub/opBSD/releases/amd64/amd64"
INSTALLER_SETS_ISO_DIR="./pub/opBSD/releases/amd64/amd64/ISO-IMAGES"
WWW_HOOKS_DIR="${RELESE_BASE_DIR}/www/"

# set reply-to to robot in mail command
REPLYTO="oliver.pinter@hardenedbsd.org"
export REPLYTO
